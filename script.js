...
style.textContent = `
  html, body {
    ...
    padding: 0;
    height: 100%;
    font-family: 'MV Boli', sans-serif; /* Updated font-family */
  ...
  /* Ensure all text elements inherit the MV Boli font */
  * {
    font-family: 'MV Boli', sans-serif; /* Apply globally */
  }
...
secondContainerContent.style.padding = '10px'; // Reduced padding for less space
secondContainerContent.style.lineHeight = '1.2'; // Reduced line height for less space between lines

// Add "Happy Birthday!" text
const happyBirthdayText = document.createElement('h1');
happyBirthdayText.textContent = "Happy Birthday!";
happyBirthdayText.style.fontSize = '2.5rem'; // Slightly larger font size
happyBirthdayText.style.color = '#EF0BBD';
happyBirthdayText.style.marginBottom = '5px'; // Reduced margin for less space
...
emojisLine.style.fontSize = '1.8rem'; // Slightly smaller font size
emojisLine.style.marginBottom = '5px'; // Reduced margin for less space
...
cutiepieText.style.fontSize = '1.5rem'; // Smaller font size
cutiepieText.style.color = '#F524C7';
cutiepieText.style.marginTop = '0'; // Remove extra space above
cutiepieText.style.marginBottom = '5px'; // Reduced margin for less space
